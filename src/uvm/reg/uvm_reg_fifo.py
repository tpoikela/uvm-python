...
from uvm.reg.uvm_reg_model import (UVM_CHECK, UVM_DEFAULT_PATH)
...
class UVMRegFIFO(UVMReg):
    ...
    #        UVM_PREDICT_DIRECT:
    #        begin
    #           if (fifo.size() != m_size  and  !m_update_in_progress)
    #             fifo.append(self.value.value)
    #        end
    #
    #        UVM_PREDICT_READ:
    #        begin
    ...
    #             return
    #           end
    #           mirror_val = fifo.pop(0)()
    #           if (self.value.get_compare() == UVM_CHECK  and  mirror_val != value):
    #              uvm_warning("MIRROR_MISMATCH",
    #               sv.sformatf("Observed DUT read value 'h%0h != mirror value 'h%0h",value,mirror_val))
    #           end
    #        end
    #
    #      endcase
    ...
    #    //
    #@cocotb.coroutine
    #    def pre_write(self,uvm_reg_item rw)
    #      if (m_set_cnt  and  !m_update_in_progress):
    ...
    #    //
    #@cocotb.coroutine
    #    def pre_read(self,uvm_reg_item rw)
    #      // abort if fifo empty
    #      if (fifo.size() == 0):
    #        rw.status = UVM_NOT_OK
    #        return
